  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        secondary:
          'border-transparent bg-secondary text-secondary-foreground hover:hover:opacity-80',
        tertiary:
          'border-transparent bg-tertiary text-tertiary-foreground hover:hover:opacity-80',
        destructive:
